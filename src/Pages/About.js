    ...
    render() {
      return (
        <Container fluid className="banner">
                    ...
                    I [1]<span className='hoverEffect'>write elegant code;</span> 
                    [2]<span className='hoverEffect'>design accessible interfaces; </span>
                    [3]<span className='hoverEffect'>deploy scalable apps; </span>
                    <br />
                    [4]<span className='hoverEffect'>author helpful documentation;</span> 
                    [5]<span className='hoverEffect'>nurture open-source communities</span> and
                    [6]<span className='hoverEffect'>build decentralized apps. </span>
